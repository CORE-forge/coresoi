...
```{r}
data %>%
  filter(data_pubblicazione >= "2016-08-26",
         data_pubblicazione < "2017-02-26",
         mcpv != "") %>%
  group_by(mcpv) %>%
  summarise(
    n_2016_post = n()
  ...
  left_join(data %>%
  filter(data_pubblicazione >= "2016-02-26",
         data_pubblicazione < "2017-08-26",
         mcpv != "") %>%
  group_by(mcpv) %>%
  summarise(
    n_2016_pre = n()
  ...
  left_join(data %>%
  filter(data_pubblicazione >= "2015-08-26",
         data_pubblicazione < "2016-02-26",
         mcpv != "") %>%
  group_by(mcpv) %>%
  summarise(
    n_2015_post = n()
  ...
  left_join(data %>%
  filter(data_pubblicazione >= "2015-02-26",
         data_pubblicazione < "2016-08-26",
         mcpv != "") %>%
  group_by(mcpv) %>%
  summarise(
    n_2015_pre = n()
