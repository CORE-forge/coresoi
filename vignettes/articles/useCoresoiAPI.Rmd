...
# Call the /aggiudicatari endpoint with a limit of 10 and a CIG of "ZEE21A100F"
get_aggiudicatari(api_key = "YOUR_API_KEY", limit = 10, cig = "ZEE21A100F")

# Call the /cigs endpoint with a limit of 20 and a minimum lotto import of 1000000
get_cigs(api_key = "YOUR_API_KEY", limit = 20, importo_lotto_min = 1000000)

# Call the /stazione-appaltante endpoint with a limit of 5 and a province name of "MILANO"
get_stazione_appaltante(api_key = "YOUR_API_KEY", limit = 5, provincia_nome = "MILANO")
```
