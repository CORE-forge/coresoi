...
- If users encounter any issues while using the package, they can refer to the documentation or reach out to the package maintainers via Github by opening an [issue](https://github.com/CORE-forge/coresoi/issues/new/choose) or direcly to ([Niccolò Salvini](mailto:niccolo.salvini27@gmail.com) or directly for technical support.
