...
All we need to do is to load data `test_data_bndcp_core` and supply related variables to function `ind_11()`. Check out the documentation for function `ind_11()` to get a grasp on that.


```{r ind11}
data("test_data_bndcp_core", package = "coresoi")
